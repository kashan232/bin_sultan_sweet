...
<div class="pos-right">
    ...
    <div class="ord-sum">
        ...
        <div class="cash-row">
            <div class="cg"><label>💵 Cash</label><input type="number" id="cashI" name="cash" value="0" min="0"></div>
            <div class="cg"><label>💳 Card</label><input type="number" id="cardI" name="card" value="0" min="0"></div>
        </div>
